...
--This query is designed to check that each employee in the employees table has a unique emp_no. If any emp_no is not unique, the query will return those emp_no values along with the count of their occurrences
